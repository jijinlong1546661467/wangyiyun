		...
		return (
			<Wrapper>
				...
				{this.scrollThreshold > 485 &&
					<div class="flex justify-between pt-[3vw] pl-[3vw] pr-[3vw] z-[999] bg-white w-[100%]" style="position: fixed;top: 0; ">
						<Icon icon="ri:arrow-left-line" style="font-size: 7vw; color:black" class="font-600 text-[5vw] "
							nativeOnClick={this.home}
						/>
						<p class=" font-[500]" style="font-size:4vw; margin-left:-68vw ;display: flex;align-items: flex-end;">
							橙留香
						</p>
				...
				{this.scrollThreshold > 258 & this.scrollThreshold < 485 &&
					<div class="flex justify-between pt-[3vw] pl-[3vw] pr-[3vw] z-[50]" style="position: sticky;top: 0; ">
						<Icon icon="ri:arrow-left-line" style="font-size: 7vw; color:black" class="font-600 text-[5vw] "
							nativeOnClick={this.home}
						/>
						{/* <Icon icon="teenyicons:more-vertical-outline" class="text-[5vw] text-black" style="font-size: 7vw;" /> */}
				...
				<div class="xuanxiangka">
					...
					<div class=" text-center relative bg-white" style="border-radius: 5vw;">
						...
						<div class="flex justify-center mt-[3vw]">
							<p class="mr-4 text-[#999ba2]" style="font-size:3vw">
								{this.guanzhu} 关注
							</p>
							<span class="mr-4 text-[#e6e6e6]" style="font-size:3vw">
								|
							</span>
							<p class="mr-4 text-[#999ba2]" style="font-size:3vw">
								{this.fenshiNum} 粉丝
						...
						<div class="flex justify-center mt-[3vw] mb-[4vw]">
							<p class="mr-4 pl-[1.5vw] pr-[1.5vw]  rounded-[1.2vw] text-[3vw] h-[6.1vw] flex" style="border: 1px solid #e6e6e6;align-items: center;">IP：霓虹人</p>
					...
					<div>
						...
						{this.value === 0 && <div>
							...
							<div class="w-[94vw]  pl-[4.4vw] pr-[4.4vw] pt-[5.2vw] bg-[#fff] rounded-[3vw] mt-[3vw] pb-[3vw]">
								...
								<div class="w-[85.5vw] h-[32.13vw] flex mt-[2.8vw]" style="justify-content: space-around;">
									<div class="w-[26.57vw] h-[32.13vw] rounded-[3vw] pt-[3vw] pl-[3.1vw] pb-[2.6vw]"
										...
										<p class="text-[#7d808c] text-[3.5vw] font-[600]" style="font-size:3.06vw">
											我的喜欢
										</p>
										<p class="text-[4vw] font-[700] text-[#515a6a] mt-[3vw]" style="font-size:3.46vw">
											{this?.establishList[0]?.trackCount}首
										</p>
										<p class="flex mt-[9.5vw] text-[#a5acb7]" style="font-size:2.69vw; align-items: center;">
											<Icon icon="ph:heart-fill" class="w-[3vw] " />
											<span class="text-[3vw] text-[#a5acb7]">
												&nbsp;喜欢的音乐
											</span>
										</p>
									...
									<div class="w-[26.57vw] h-[32.13vw] rounded-[3vw] pt-[3vw] pl-[3.1vw] pb-[2.6vw]"
										...
										<p class="flex mt-[9.5vw] text-[#a5acb7]" style="font-size:2.69vw; align-items: center;">
											<Icon icon="fa6-solid:ranking-star" class="w-[3vw]" />
											<span class="text-[3vw] text-[#a5acb7]">
												&nbsp;喜欢的音乐
											</span>
										</p>
									...
									<div class="w-[26.57vw] h-[32.13vw] rounded-[3vw] pt-[3vw] pl-[3.1vw] pb-[2.6vw]"
										...
										<p class="text-[4vw] font-[700] text-[#515a6a] mt-[2vw] pr-[7vw]" style="font-size:3.46vw">
											属于你的音乐档案
										</p>
										<p class="flex mt-[5vw] text-[#a5acb7]" style="font-size:2.69vw; align-items: center;">
											<Icon icon="ant-design:hourglass-filled" class="w-[3vw]" />
											<span class="text-[3vw] text-[#a5acb7]">
												&nbsp;黑胶时光机
											</span>
										</p>
							...
							<div class="w-[94vw]  pl-[4.4vw] pb-[3.8vw] pr-[4.4vw] pt-[5.2vw] bg-[#fff] rounded-[3vw] mt-[3vw]">
								<p class="text-[5vw] font-[540]" style="font-size:4.63vw">
									创建的歌单
									<span class="text-[#d5d5d5] text-[3vw]">
										({this.establishList.length}个)
									</span>
								</p>
							...
							<div class="w-[94vw]  pl-[4.4vw] pb-[3.8vw] pr-[4.4vw] pt-[5.2vw] bg-[#fff] rounded-[3vw] mt-[3vw]">
								...
								{this.songList.slice(0, 10).map((item) => (
									<div class="flex  mt-[3vw]" >
										<div class="w-[14.35vw] h-[14.35vw]">
											<img src={item.coverImgUrl} alt="" class="w-[14.35vw] h-[14.35vw] rounded-[2vw] bg-black z-[2] " style=";" />
										</div>
										<div class="ml-[3vw] w-[64vw] flex " style="flex-direction: column;justify-content: space-around">
											<p class="overflow-hidden overflow-ellipsis whitespace-nowrap  font-[530] w-[64vw]" style="font-size:4.1vw">
												{item.name}
											</p>
											<p class="overflow-hidden overflow-ellipsis whitespace-nowrap  text-[#808080] w-[64vw]" style="font-size:3vw">
												{item.trackCount}首，
												{item.creator.nickname}，播放
							...
							<div class="w-[94vw]  pl-[4.4vw] pb-[3.8vw] pr-[4.4vw] pt-[5.2vw] bg-[#fff] rounded-[3vw] mt-[3vw]">
								<div class="flex justify-between mb-[4.4vw]">
									<p class=" font-[540] text-[5vw] " style="font-size:4.63vw">
										我的评论
										<span class="text-[#d5d5d5] text-[2.7vw] ml-[1.6vw] font-[540]">
											({this.commentCount})
										</span>
									</p>
						...
						{this.value === 2 && <div>
							...
							<div class="w-[94vw] pb-[3.8vw] pl-[4.4vw] pr-[4.4vw] pt-[5.2vw] bg-[#fff] rounded-[3vw] mt-[3vw]">
								<p class="text-[5vw] font-[540]" style="font-size:4.63vw">创建的播客 <span class="text-[#d5d5d5] text-[3vw]">(1)</span></p>
								<div class="flex  mt-[3vw]">
									<div class="w-[14.35vw] h-[14.35vw]">
									...
									<div class="ml-[3vw] flex" style="flex-direction: column;justify-content: space-around;">
										<p class="overflow-hidden overflow-ellipsis whitespace-nowrap text-[4.1vw] font-[500]">橙留香</p>
							...
							{/* 收藏的播客*/}
							<div class="w-[94vw] pb-[3.8vw] pl-[4.4vw] pr-[4.4vw] pt-[5.2vw] bg-[#fff] rounded-[3vw] mt-[3vw]">
								<p class="text-[5vw] font-[540]" style="font-size:4.63vw"> 收藏的播客 <span class="text-[#d5d5d5] text-[3vw]">(1)</span></p>
								<div class="flex  mt-[3vw]">
									<div class="w-[14.35vw] h-[14.35vw]">
